...
static constexpr auto qt_meta_stringdata_ZN21QDeviceClosedNotifierE = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_ZN21QDeviceClosedNotifierE[] = {
...
Q_CONSTINIT const QMetaObject QDeviceClosedNotifier::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN21QDeviceClosedNotifierE.offsetsAndSizes,
    qt_meta_data_ZN21QDeviceClosedNotifierE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN21QDeviceClosedNotifierE_t,
        // Q_OBJECT / Q_GADGET
...
void *QDeviceClosedNotifier::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN21QDeviceClosedNotifierE.stringdata0))
